...
// necesitaremos separar la lógica de la interfaz gráfica del método crearFunciones para poder probarla fácilmente.
    
//    private int mostrarDialogo(){
//        String B[] = {"Normal","Contrarreloj","Con Bordes"};
//            return JOptionPane.showOptionDialog(this, "Opciones para Iniciar el Juego", "Opciones - Snake",
//             JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE, null, B, accessibleContext);
//        }
//
//        public int getOpcion(){
//            this.opcion = mostrarDialogo();
//            return this.opcion;
//        }
//    }
}
